...
active_text_color="$(cat ~/.config/polybar/colors.ini | grep primary | cut -d '=' -f 2 | sed 's/ //g')"
#active_text_color="#00DFDF"
active_bg=
active_underline=

inactive_text_color="#D8D8D8"
inactive_bg=
inactive_underline=

separator="·"
show="window_class" # options: window_title, window_class, window_classname
forbidden_classes="Plank Polybar Conky Gmrun"
